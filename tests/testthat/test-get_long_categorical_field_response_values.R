...
output <- get_long_categorical_field_response_values(long_categorical_field_responses)

testthat::test_that("get_long_categorical_field_response_values: ethnicity, occupation, race, and state are represented", {
...
testthat::test_that("get_long_categorical_field_response_values: bl_caffeine, bl_exercise, and bl_treatments are represented", {
  testthat::expect_true(all.equal(
    output |>
